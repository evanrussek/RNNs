...
def gen_batch_data(batch_size, batch_idx, sim_data):
    ...
    batch_sequences_cat = [[to_categorical(x, num_classes=3) for x in this_sequence] for this_sequence in
                           batch_sequences_idx]
...
def objective(trial):
    # generate some train and sim data
    ...
    max_epochs = 100  # let's just set it to this to start
